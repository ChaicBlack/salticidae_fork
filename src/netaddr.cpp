...
netaddr_t *netaddr_copy(const netaddr_t *self) { return new netaddr_t(*self); }

bool netaddr_is_eq(const netaddr_t *a, const netaddr_t *b) { return *a == *b; }
...
netaddr_array_t *netaddr_array_new_from_addrs(const netaddr_t *const *addrs,
                                              size_t naddrs) {
